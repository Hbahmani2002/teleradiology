...
let KosstatisticComponent = class KosstatisticComponent {
    ...
    onRefresh() {
        let filter = new src_app_Shared_Models_UIControls_grid_control__WEBPACK_IMPORTED_MODULE_4__["Grid"].GridInputModel(new _Models_infStudyFilter__WEBPACK_IMPORTED_MODULE_3__["infStudyFilter"]());
        this.kosService.GetKosDurumIst(filter).subscribe(data => {
            console.log(data);
...
let FileService = class FileService {
    ...
    Download(fileID) {
        debugger;
        this.apiDataService.callDataService('/FileOperation/Download', fileID).subscribe(resp => {
            console.log(resp);
        });
    }
};
...
//# sourceMappingURL=main-es2015.fd52bf403840e1324390.js.map