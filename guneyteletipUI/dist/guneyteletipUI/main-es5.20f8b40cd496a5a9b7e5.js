...
/***/ "./node_modules/raw-loader/index.js!./src/app/Shared/Modals/inputmodal/inputmodal.component.html":
/*!**********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/Shared/Modals/inputmodal/inputmodal.component.html ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"modal-header\">\r\n  <h4 class=\"modal-title pull-left\">{{inputName}}</h4>\r\n  <button type=\"button\" class=\"close pull-right\" aria-label=\"Close\" (click)=\"modal.onClose('carpi')\">\r\n    <span aria-hidden=\"true\">&times;</span>\r\n  </button>\r\n</div>\r\n<div class=\"modal-body\">\r\n  <div class=\"form-group row m-1\">\r\n    <div class=\"col-sm-12\">\r\n      <input placeholder=\"{{inputName}}\" type=\"text\" class=\"form-control\" [(ngModel)]=\"inputValue\">\r\n    </div>\r\n  </div>\r\n</div>\r\n<div class=\"modal-footer\">\r\n  <button type=\"button\" class=\"btn btn-danger\" (click)=\"onCancel()\">İptal</button>\r\n  <button type=\"button\" class=\"btn btn-primary\" (click)=\"onConfirm()\">Tamam</button>\r\n</div>\r\n"
...
/* harmony import */ var src_app_Shared_Modals_inputmodal_inputmodal_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! src/app/Shared/Modals/inputmodal/inputmodal.component */ "./src/app/Shared/Modals/inputmodal/inputmodal.component.ts");
...
(function (KosListComponent_Models) {
    var GridUser = /** @class */ (function (_super) {
        ...
        ;
        GridUser.prototype.onChangeAccesionNo = function () {
            var _this = this;
            var initialState = {
                inputName: "Accession No",
            };
            this.modal.openModal(src_app_Shared_Modals_inputmodal_inputmodal_component__WEBPACK_IMPORTED_MODULE_9__["InputmodalComponent"], initialState).subscribe(function (result) {
                if (result.reason == "ok" && result.outputData != undefined) {
                    var params = _this.getFilter(1);
                    params.filter.newAccesionNo = result.outputData;
                    console.log(params);
                    _this.kosService.changeAccessionNo(params).subscribe(function (resp) {
                        _this.onRefresh();
                    });
                }
            });
        ...
        GridUser.prototype.onRemoveKosStudy = function () {
            var _this = this;
            var initialState = {
            ...
            this.modal.openModal(src_app_Shared_Modals_inputmodal_inputmodal_component__WEBPACK_IMPORTED_MODULE_9__["InputmodalComponent"], initialState).subscribe(function (result) {
                console.log(result.reason);
                console.log(result.outputData);
                var params = { studyUID: result.outputData };
                _this.kosService.removeKosStudy(params).subscribe(function (resp) {
                    console.log(resp);
                });
            });
        };
...
var kosDataServices = /** @class */ (function () {
    ...
    kosDataServices.prototype.changeAccessionNo = function (model) {
        console.log(model);
        debugger;
    ...
    kosDataServices.prototype.removeKosStudy = function (params) {
...
/***/ "./src/app/Shared/Modals/inputmodal/inputmodal.component.css":
/*!*******************************************************************!*\
  !*** ./src/app/Shared/Modals/inputmodal/inputmodal.component.css ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL1NoYXJlZC9Nb2RhbHMvaW5wdXRtb2RhbC9pbnB1dG1vZGFsLmNvbXBvbmVudC5jc3MifQ== */"

/***/ }),

/***/ "./src/app/Shared/Modals/inputmodal/inputmodal.component.ts":
/*!******************************************************************!*\
  !*** ./src/app/Shared/Modals/inputmodal/inputmodal.component.ts ***!
  \******************************************************************/
...
var InputmodalComponent = /** @class */ (function () {
    function InputmodalComponent(bsModalRef, modalService, changeDetection) {
        this.bsModalRef = bsModalRef;
        this.modalService = modalService;
        this.changeDetection = changeDetection;
        this.output = undefined; // modal'ın açıldığı sayfada modal kapandıktan sonra aktarılacak veri 
    ...
    InputmodalComponent.prototype.ngOnInit = function () { };
    InputmodalComponent.prototype.onConfirm = function () {
        this.output = this.inputValue;
        this.modal.onClose("ok");
    };
    InputmodalComponent.prototype.onCancel = function () {
        this.output = false;
        this.modal.onClose("cancel");
    };
    InputmodalComponent.ctorParameters = function () { return [
        { type: ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_2__["BsModalRef"] },
        { type: ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_2__["BsModalService"] },
        { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"] }
    ]; };
    InputmodalComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-inputmodal',
            template: __webpack_require__(/*! raw-loader!./inputmodal.component.html */ "./node_modules/raw-loader/index.js!./src/app/Shared/Modals/inputmodal/inputmodal.component.html"),
            styles: [__webpack_require__(/*! ./inputmodal.component.css */ "./src/app/Shared/Modals/inputmodal/inputmodal.component.css")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_2__["BsModalRef"], ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_2__["BsModalService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"]])
    ], InputmodalComponent);
...
/* harmony import */ var _Shared_Modals_inputmodal_inputmodal_component__WEBPACK_IMPORTED_MODULE_70__ = __webpack_require__(/*! ./Shared/Modals/inputmodal/inputmodal.component */ "./src/app/Shared/Modals/inputmodal/inputmodal.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _Shared_Modals_inputmodal_inputmodal_component__WEBPACK_IMPORTED_MODULE_70__["InputmodalComponent"]
            ],
            imports: [
...
//# sourceMappingURL=main-es5.20f8b40cd496a5a9b7e5.js.map