...
/* harmony import */ var src_app_Shared_Models_UIControls_grid_control__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/Shared/Models/UIControls/grid-control */ "./src/app/Shared/Models/UIControls/grid-control.ts");
...
var KosstatisticComponent = /** @class */ (function () {
    ...
    KosstatisticComponent.prototype.onRefresh = function () {
        var _this = this;
        var filter = new src_app_Shared_Models_UIControls_grid_control__WEBPACK_IMPORTED_MODULE_4__["Grid"].GridInputModel(new _Models_infStudyFilter__WEBPACK_IMPORTED_MODULE_3__["infStudyFilter"]());
        this.kosService.GetKosDurumIst(filter).subscribe(function (data) {
            console.log(data);
...
var SidetestComponent = /** @class */ (function () {
    function SidetestComponent(logoutService, modalService, changeDetection) {
        this.logoutService = logoutService;
        this.modalService = modalService;
        this.changeDetection = changeDetection;
        this.collapse = false;
...
var FileService = /** @class */ (function () {
    ...
    FileService.prototype.download = function (fileID, newTab) {
        ...
        if (!fileID)
            return;
        var url = _Consts_parameters__WEBPACK_IMPORTED_MODULE_2__["parameters"].serverAddress + "FileOperation/Download?fileID=" + fileID;
    ...
    FileService.prototype.Download = function (fileID) {
        debugger;
        this.apiDataService.callDataService('/FileOperation/Download', fileID).subscribe(function (resp) {
            console.log(resp);
        });
    };
...
//# sourceMappingURL=main-es5.472578e8e6f8431689f5.js.map