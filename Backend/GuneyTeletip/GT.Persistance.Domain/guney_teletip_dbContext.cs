...
namespace GT.Persistance.Domain
{
    public partial class guney_teletip_dbContext : DbContext
    {
        ...
        public virtual DbSet<Kartal> Kartal { get; set; }
        public virtual DbSet<Kartaladsm> Kartaladsm { get; set; }
        ...
        public virtual DbSet<KosKurumlar> KosKurumlar { get; set; }
        ...
        public virtual DbSet<KosStudyYd10082020> KosStudyYd10082020 { get; set; }
        public virtual DbSet<KosStudyYedek> KosStudyYedek { get; set; }
        public virtual DbSet<Marmara> Marmara { get; set; }
        public virtual DbSet<MarmaraSon> MarmaraSon { get; set; }
        ...
        public virtual DbSet<Sultanbeyli> Sultanbeyli { get; set; }
        public virtual DbSet<Sureyya> Sureyya { get; set; }
        public virtual DbSet<Tuzla> Tuzla { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseNpgsql("Host=10.218.160.49;Database=guney_teletip_db;Username=postgres;Password=Prt*2021+-;Port=54320");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Kartal>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("kartal");
            ...
            modelBuilder.Entity<Kartaladsm>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("kartaladsm");
            ...
            modelBuilder.Entity<KosInstance>(entity =>
            {
                ...
                entity.HasIndex(e => e.InstanceLocKey)
                    .HasName("InstanceLocKey")
                    .IsUnique();
                ...
                entity.Property(e => e.InstanceDcmdirPath)
                    .HasColumnName("Instance_dcmdir_path")
                    .HasMaxLength(2048);
            ...
            modelBuilder.Entity<KosKurumlar>(entity =>
            {
                entity.HasKey(e => e.KrmId)
                    .HasName("kos_kurumlar_pkey");

                entity.ToTable("kos_kurumlar");

                entity.Property(e => e.KrmId).HasColumnName("KrmID");

                entity.Property(e => e.KurumAd).HasColumnType("character varying");

                entity.Property(e => e.KurumOnEk).HasColumnType("character varying");
            });
            ...
            modelBuilder.Entity<KosStudy>(entity =>
            {
                ...
                entity.Property(e => e.KrmOnEk).HasColumnType("character varying");
            ...
            modelBuilder.Entity<KosStudyHistory>(entity =>
            {
                ...
                entity.HasIndex(e => e.FkKosStudy)
                    .HasName("kos_study_history_fk_kos_study_index");
            ...
            modelBuilder.Entity<KosStudyYd10082020>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("kos_study_yd10082020");
            ...
            modelBuilder.Entity<Marmara>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("marmara");
            ...
            modelBuilder.Entity<MarmaraSon>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("marmara_son");
            ...
            modelBuilder.Entity<Sultanbeyli>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("sultanbeyli");
            ...
            modelBuilder.Entity<Sureyya>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("sureyya");
            ...
            modelBuilder.Entity<Tuzla>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("tuzla");
