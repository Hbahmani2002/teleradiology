...
namespace GT.UI.WebApi.Controllers
{
    ...
    public class AppController : ControllerBase
    {
        ...
        public string GetInfo()
        {
            ...
            var MakeKosJarName = "MakeKOS_v21.jar";
            var output = $"/dicom/kos/test_{Guid.NewGuid().ToString().Replace("-", "")}.dcm";
            var input = "/dicom/study/YKCK01/20200519/E0071610";
            var makeKosAppLocation = "/app/teletip_kos/MakeKOS_v21.jar";
            var tempTLocation = "/dicom/temp_kos";
            var dcmLocation = "/app/teletip_kos/dcm4che-5.22.2/bin";
            var res = $@"{makeKosAppLocation} --title DCM-113030 --location-uid  1.3.6.1.4.1.21367.2017.10.26.111 --temp-tlocation {tempTLocation} --dcm-dcmlocation {dcmLocation} -o {output} {input}";
